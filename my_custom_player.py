...
class MCTS:
    ...
    def __init__(self, simulations, player_id, exploration_factor=1.4, expert_factor=2.0, expansion_threshold=100, rollout_times=10):
    ...
    def select_next_best_node(self, node):
        ...
        for child_key in children.keys():
            ...
            exploration_value = self.exploration_factor * \
            ...
            print("CHILD KEY", child_key, "EXPLOIT",
                  exploitation_value, "EXPLORE", exploration_value)
